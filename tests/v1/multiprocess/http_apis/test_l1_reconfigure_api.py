...
class _FakeStorageManager:
    ...
    def remove_l1_devdax_device(
        ...
        self._raise_if_configured()
        return _arena_status(device_path, state=DevDaxArenaState.REMOVED)
...
def test_l1_dax_backend_and_resolver_errors() -> None:
    """The public path answers 409 for CPU L1 and 503 without an engine."""
